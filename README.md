...
女娲已蒸馏了14位人物 + 1个主题。每个都是独立的、可直接安装使用的Skill：
...
**14 person skills + 1 topic skill included** — all with full research data. The Jobs example includes a complete multi-turn conversation demo.
